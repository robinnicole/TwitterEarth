...
$( document ).ready( function(){
	...
	window.cube = new THREE.Mesh( new THREE.CubeGeometry( 100, 100, 100 ), new THREE.MeshNormalMaterial());
...
/*
	   ...
	   var cube = new THREE.Mesh(new THREE.CubeGeometry(30, 30, 300), material);
        cube.overdraw = true;
        scene.add(cube);
